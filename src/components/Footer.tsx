...
export default function Footer() {
  ...
  const friendLinks = [
    { key: 'moldovaCulture', url: 'https://mc.gov.md/' },
    { key: 'moldovaTourism', url: 'https://turism.gov.md/' },
    { key: 'monumente', url: 'https://airm.md/' },
    { key: 'chisinau', url: 'https://www.chisinau.md/' },
    { key: 'chisinauProjects', url: 'https://proiecte.chisinau.md/' },
  ];
